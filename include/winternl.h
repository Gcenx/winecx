...
NTSYSAPI NTSTATUS  WINAPI NtReadVirtualMemory(HANDLE,const void* HOSTPTR,void*,SIZE_T,SIZE_T*) __attribute__((overloadable)) asm(__ASM_NAME("wine_NtReadVirtualMemory_HOSTPTR"));
#endif
