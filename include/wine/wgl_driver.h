...
#ifdef WINE_GL_WIN32
#define WINEGLDEF(x) x
#define WINE_OPENGL_FUNCS _wine_win32_opengl_funcs
#else
#define WINEGLDEF(x) _wine_host_##x
#define WINE_OPENGL_FUNCS opengl_funcs
#include "hostaddrspace_enter.h"
#endif
#else
#define WINEGLDEF(x) x
#define WINE_OPENGL_FUNCS opengl_funcs
...
struct opengl_funcs_ext
{
    ...
    GLuint     (WINE_GLAPI *p_glAsyncCopyBufferSubDataNVX)( GLsizei waitSemaphoreCount, const GLuint *waitSemaphoreArray, const GLuint64 *fenceValueArray, GLuint readGpu, GLbitfield writeGpuMask, GLuint readBuffer, GLuint writeBuffer, WINEGLDEF(GLintptr) readOffset, WINEGLDEF(GLintptr) writeOffset, WINEGLDEF(GLsizeiptr) size, GLsizei signalSemaphoreCount, const GLuint *signalSemaphoreArray, const GLuint64 *signalValueArray );
    ...
    void       (WINE_GLAPI *p_glBindBufferOffsetEXT)( GLenum target, GLuint index, GLuint buffer, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glBindBufferOffsetNV)( GLenum target, GLuint index, GLuint buffer, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glBindBufferRange)( GLenum target, GLuint index, GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size );
    void       (WINE_GLAPI *p_glBindBufferRangeEXT)( GLenum target, GLuint index, GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size );
    void       (WINE_GLAPI *p_glBindBufferRangeNV)( GLenum target, GLuint index, GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size );
    void       (WINE_GLAPI *p_glBindBuffersBase)( GLenum target, GLuint first, GLsizei count, const GLuint *buffers );
    void       (WINE_GLAPI *p_glBindBuffersRange)( GLenum target, GLuint first, GLsizei count, const GLuint *buffers, const WINEGLDEF(GLintptr) *offsets, const WINEGLDEF(GLsizeiptr) *sizes );
    ...
    void       (WINE_GLAPI *p_glBindVertexBuffer)( GLuint bindingindex, GLuint buffer, WINEGLDEF(GLintptr) offset, GLsizei stride );
    void       (WINE_GLAPI *p_glBindVertexBuffers)( GLuint first, GLsizei count, const GLuint *buffers, const WINEGLDEF(GLintptr) *offsets, const GLsizei *strides );
    void       (WINE_GLAPI *p_glBindVertexShaderEXT)( GLuint id );
    void       (WINE_GLAPI *p_glBindVideoCaptureStreamBufferNV)( GLuint video_capture_slot, GLuint stream, GLenum frame_region, WINEGLDEF(GLintptrARB) offset );
    ...
    void       (WINE_GLAPI *p_glBufferAddressRangeNV)( GLenum pname, GLuint index, GLuint64EXT address, WINEGLDEF(GLsizeiptr) length );
    void       (WINE_GLAPI *p_glBufferAttachMemoryNV)( GLenum target, GLuint memory, GLuint64 offset );
    void       (WINE_GLAPI *p_glBufferData)( GLenum target, WINEGLDEF(GLsizeiptr) size, const void *data, GLenum usage );
    void       (WINE_GLAPI *p_glBufferDataARB)( GLenum target, WINEGLDEF(GLsizeiptrARB) size, const void *data, GLenum usage );
    void       (WINE_GLAPI *p_glBufferPageCommitmentARB)( GLenum target, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, GLboolean commit );
    ...
    void       (WINE_GLAPI *p_glBufferStorage)( GLenum target, WINEGLDEF(GLsizeiptr) size, const void *data, GLbitfield flags );
    void       (WINE_GLAPI *p_glBufferStorageExternalEXT)( GLenum target, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, GLeglClientBufferEXT clientBuffer, GLbitfield flags );
    void       (WINE_GLAPI *p_glBufferStorageMemEXT)( GLenum target, WINEGLDEF(GLsizeiptr) size, GLuint memory, GLuint64 offset );
    void       (WINE_GLAPI *p_glBufferSubData)( GLenum target, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, const void *data );
    void       (WINE_GLAPI *p_glBufferSubDataARB)( GLenum target, WINEGLDEF(GLintptrARB) offset, WINEGLDEF(GLsizeiptrARB) size, const void *data );
    ...
    void       (WINE_GLAPI *p_glClearBufferSubData)( GLenum target, GLenum internalformat, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, GLenum format, GLenum type, const void *data );
    ...
    void       (WINE_GLAPI *p_glClearNamedBufferSubData)( GLuint buffer, GLenum internalformat, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, GLenum format, GLenum type, const void *data );
    void       (WINE_GLAPI *p_glClearNamedBufferSubDataEXT)( GLuint buffer, GLenum internalformat, WINEGLDEF(GLsizeiptr) offset, WINEGLDEF(GLsizeiptr) size, GLenum format, GLenum type, const void *data );
    ...
    void       (WINE_GLAPI *p_glCopyBufferSubData)( GLenum readTarget, GLenum writeTarget, WINEGLDEF(GLintptr) readOffset, WINEGLDEF(GLintptr) writeOffset, WINEGLDEF(GLsizeiptr) size );
    ...
    void       (WINE_GLAPI *p_glCopyNamedBufferSubData)( GLuint readBuffer, GLuint writeBuffer, WINEGLDEF(GLintptr) readOffset, WINEGLDEF(GLintptr) writeOffset, WINEGLDEF(GLsizeiptr) size );
    ...
    void       (WINE_GLAPI *p_glDispatchComputeIndirect)( WINEGLDEF(GLintptr) indirect );
    ...
    void       (WINE_GLAPI *p_glDrawCommandsNV)( GLenum primitiveMode, GLuint buffer, const WINEGLDEF(GLintptr) *indirects, const GLsizei *sizes, GLuint count );
    ...
    void       (WINE_GLAPI *p_glDrawCommandsStatesNV)( GLuint buffer, const WINEGLDEF(GLintptr) *indirects, const GLsizei *sizes, const GLuint *states, const GLuint *fbos, GLuint count );
    ...
    void       (WINE_GLAPI *p_glDrawMeshTasksIndirectNV)( WINEGLDEF(GLintptr) indirect );
    ...
    void       (WINE_GLAPI *p_glFlushMappedBufferRange)( GLenum target, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) length );
    void       (WINE_GLAPI *p_glFlushMappedBufferRangeAPPLE)( GLenum target, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size );
    void       (WINE_GLAPI *p_glFlushMappedNamedBufferRange)( GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) length );
    void       (WINE_GLAPI *p_glFlushMappedNamedBufferRangeEXT)( GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) length );
    ...
    void       (WINE_GLAPI *p_glGetBufferSubData)( GLenum target, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, void *data );
    void       (WINE_GLAPI *p_glGetBufferSubDataARB)( GLenum target, WINEGLDEF(GLintptrARB) offset, WINEGLDEF(GLsizeiptrARB) size, void *data );
    ...
    void       (WINE_GLAPI *p_glGetNamedBufferSubData)( GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, void *data );
    void       (WINE_GLAPI *p_glGetNamedBufferSubDataEXT)( GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, void *data );
    ...
    void       (WINE_GLAPI *p_glGetQueryBufferObjecti64v)( GLuint id, GLuint buffer, GLenum pname, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glGetQueryBufferObjectiv)( GLuint id, GLuint buffer, GLenum pname, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glGetQueryBufferObjectui64v)( GLuint id, GLuint buffer, GLenum pname, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glGetQueryBufferObjectuiv)( GLuint id, GLuint buffer, GLenum pname, WINEGLDEF(GLintptr) offset );
    ...
    WINEGLDEF(GLintptr) (WINE_GLAPI *p_glGetUniformOffsetEXT)( GLuint program, GLint location );
    ...
    GLsync     (WINE_GLAPI *p_glImportSyncEXT)( GLenum external_sync_type, WINEGLDEF(GLintptr) external_sync, GLbitfield flags );
    ...
    void       (WINE_GLAPI *p_glInvalidateBufferSubData)( GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) length );
    ...
    void       (WINE_GLAPI *p_glLGPUNamedBufferSubDataNVX)( GLbitfield gpuMask, GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, const void *data );
    ...
    void *     (WINE_GLAPI *p_glMapBufferRange)( GLenum target, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) length, GLbitfield access );
    ...
    void *     (WINE_GLAPI *p_glMapNamedBufferRange)( GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) length, GLbitfield access );
    void *     (WINE_GLAPI *p_glMapNamedBufferRangeEXT)( GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) length, GLbitfield access );
    ...
    void       (WINE_GLAPI *p_glMultiDrawArraysIndirectCount)( GLenum mode, const void *indirect, WINEGLDEF(GLintptr) drawcount, GLsizei maxdrawcount, GLsizei stride );
    void       (WINE_GLAPI *p_glMultiDrawArraysIndirectCountARB)( GLenum mode, const void *indirect, WINEGLDEF(GLintptr) drawcount, GLsizei maxdrawcount, GLsizei stride );
    ...
    void       (WINE_GLAPI *p_glMultiDrawElementsIndirectCount)( GLenum mode, GLenum type, const void *indirect, WINEGLDEF(GLintptr) drawcount, GLsizei maxdrawcount, GLsizei stride );
    void       (WINE_GLAPI *p_glMultiDrawElementsIndirectCountARB)( GLenum mode, GLenum type, const void *indirect, WINEGLDEF(GLintptr) drawcount, GLsizei maxdrawcount, GLsizei stride );
    void       (WINE_GLAPI *p_glMultiDrawMeshTasksIndirectCountNV)( WINEGLDEF(GLintptr) indirect, WINEGLDEF(GLintptr) drawcount, GLsizei maxdrawcount, GLsizei stride );
    void       (WINE_GLAPI *p_glMultiDrawMeshTasksIndirectNV)( WINEGLDEF(GLintptr) indirect, GLsizei drawcount, GLsizei stride );
    ...
    void       (WINE_GLAPI *p_glMulticastBufferSubDataNV)( GLbitfield gpuMask, GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, const void *data );
    void       (WINE_GLAPI *p_glMulticastCopyBufferSubDataNV)( GLuint readGpu, GLbitfield writeGpuMask, GLuint readBuffer, GLuint writeBuffer, WINEGLDEF(GLintptr) readOffset, WINEGLDEF(GLintptr) writeOffset, WINEGLDEF(GLsizeiptr) size );
    ...
    void       (WINE_GLAPI *p_glNamedBufferData)( GLuint buffer, WINEGLDEF(GLsizeiptr) size, const void *data, GLenum usage );
    void       (WINE_GLAPI *p_glNamedBufferDataEXT)( GLuint buffer, WINEGLDEF(GLsizeiptr) size, const void *data, GLenum usage );
    void       (WINE_GLAPI *p_glNamedBufferPageCommitmentARB)( GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, GLboolean commit );
    void       (WINE_GLAPI *p_glNamedBufferPageCommitmentEXT)( GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, GLboolean commit );
    void       (WINE_GLAPI *p_glNamedBufferStorage)( GLuint buffer, WINEGLDEF(GLsizeiptr) size, const void *data, GLbitfield flags );
    void       (WINE_GLAPI *p_glNamedBufferStorageEXT)( GLuint buffer, WINEGLDEF(GLsizeiptr) size, const void *data, GLbitfield flags );
    void       (WINE_GLAPI *p_glNamedBufferStorageExternalEXT)( GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, GLeglClientBufferEXT clientBuffer, GLbitfield flags );
    void       (WINE_GLAPI *p_glNamedBufferStorageMemEXT)( GLuint buffer, WINEGLDEF(GLsizeiptr) size, GLuint memory, GLuint64 offset );
    void       (WINE_GLAPI *p_glNamedBufferSubData)( GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, const void *data );
    void       (WINE_GLAPI *p_glNamedBufferSubDataEXT)( GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size, const void *data );
    void       (WINE_GLAPI *p_glNamedCopyBufferSubDataEXT)( GLuint readBuffer, GLuint writeBuffer, WINEGLDEF(GLintptr) readOffset, WINEGLDEF(GLintptr) writeOffset, WINEGLDEF(GLsizeiptr) size );
    ...
    GLenum     (WINE_GLAPI *p_glPathMemoryGlyphIndexArrayNV)( GLuint firstPathName, GLenum fontTarget, WINEGLDEF(GLsizeiptr) fontSize, const void *fontData, GLsizei faceIndex, GLuint firstGlyphIndex, GLsizei numGlyphs, GLuint pathParameterTemplate, GLfloat emScale );
    ...
    void       (WINE_GLAPI *p_glTexBufferRange)( GLenum target, GLenum internalformat, GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size );
    ...
    void       (WINE_GLAPI *p_glTextureBufferRange)( GLuint texture, GLenum internalformat, GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size );
    void       (WINE_GLAPI *p_glTextureBufferRangeEXT)( GLuint texture, GLenum target, GLenum internalformat, GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size );
    ...
    void       (WINE_GLAPI *p_glTransformFeedbackBufferRange)( GLuint xfb, GLuint index, GLuint buffer, WINEGLDEF(GLintptr) offset, WINEGLDEF(GLsizeiptr) size );
    ...
    WINEGLDEF(GLvdpauSurfaceNV) (WINE_GLAPI *p_glVDPAURegisterOutputSurfaceNV)( const void *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames );
    WINEGLDEF(GLvdpauSurfaceNV) (WINE_GLAPI *p_glVDPAURegisterVideoSurfaceNV)( const void *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames );
    WINEGLDEF(GLvdpauSurfaceNV) (WINE_GLAPI *p_glVDPAURegisterVideoSurfaceWithPictureStructureNV)( const void *vdpSurface, GLenum target, GLsizei numTextureNames, const GLuint *textureNames, GLboolean isFrameStructure );
    void       (WINE_GLAPI *p_glVDPAUSurfaceAccessNV)( WINEGLDEF(GLvdpauSurfaceNV) surface, GLenum access );
    void       (WINE_GLAPI *p_glVDPAUUnmapSurfacesNV)( GLsizei numSurface, const WINEGLDEF(GLvdpauSurfaceNV) *surfaces );
    void       (WINE_GLAPI *p_glVDPAUUnregisterSurfaceNV)( WINEGLDEF(GLvdpauSurfaceNV) surface );
    ...
    void       (WINE_GLAPI *p_glVertexArrayBindVertexBufferEXT)( GLuint vaobj, GLuint bindingindex, GLuint buffer, WINEGLDEF(GLintptr) offset, GLsizei stride );
    void       (WINE_GLAPI *p_glVertexArrayBindingDivisor)( GLuint vaobj, GLuint bindingindex, GLuint divisor );
    void       (WINE_GLAPI *p_glVertexArrayColorOffsetEXT)( GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glVertexArrayEdgeFlagOffsetEXT)( GLuint vaobj, GLuint buffer, GLsizei stride, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glVertexArrayElementBuffer)( GLuint vaobj, GLuint buffer );
    void       (WINE_GLAPI *p_glVertexArrayFogCoordOffsetEXT)( GLuint vaobj, GLuint buffer, GLenum type, GLsizei stride, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glVertexArrayIndexOffsetEXT)( GLuint vaobj, GLuint buffer, GLenum type, GLsizei stride, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glVertexArrayMultiTexCoordOffsetEXT)( GLuint vaobj, GLuint buffer, GLenum texunit, GLint size, GLenum type, GLsizei stride, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glVertexArrayNormalOffsetEXT)( GLuint vaobj, GLuint buffer, GLenum type, GLsizei stride, WINEGLDEF(GLintptr) offset );
    ...
    void       (WINE_GLAPI *p_glVertexArraySecondaryColorOffsetEXT)( GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glVertexArrayTexCoordOffsetEXT)( GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, WINEGLDEF(GLintptr) offset );
    ...
    void       (WINE_GLAPI *p_glVertexArrayVertexAttribIOffsetEXT)( GLuint vaobj, GLuint buffer, GLuint index, GLint size, GLenum type, GLsizei stride, WINEGLDEF(GLintptr) offset );
    ...
    void       (WINE_GLAPI *p_glVertexArrayVertexAttribLOffsetEXT)( GLuint vaobj, GLuint buffer, GLuint index, GLint size, GLenum type, GLsizei stride, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glVertexArrayVertexAttribOffsetEXT)( GLuint vaobj, GLuint buffer, GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, WINEGLDEF(GLintptr) offset );
    void       (WINE_GLAPI *p_glVertexArrayVertexBindingDivisorEXT)( GLuint vaobj, GLuint bindingindex, GLuint divisor );
    void       (WINE_GLAPI *p_glVertexArrayVertexBuffer)( GLuint vaobj, GLuint bindingindex, GLuint buffer, WINEGLDEF(GLintptr) offset, GLsizei stride );
    void       (WINE_GLAPI *p_glVertexArrayVertexBuffers)( GLuint vaobj, GLuint first, GLsizei count, const GLuint *buffers, const WINEGLDEF(GLintptr) *offsets, const GLsizei *strides );
    void       (WINE_GLAPI *p_glVertexArrayVertexOffsetEXT)( GLuint vaobj, GLuint buffer, GLint size, GLenum type, GLsizei stride, WINEGLDEF(GLintptr) offset );
    ...
    void *WIN32PTR (WINE_GLAPI *p_wglAllocateMemoryNV)( GLsizei size, GLfloat readfreq, GLfloat writefreq, GLfloat priority );
    BOOL       (WINE_GLAPI *p_wglBindTexImageARB)( struct wgl_pbuffer *WIN32PTR hPbuffer, int iBuffer );
    BOOL       (WINE_GLAPI *p_wglChoosePixelFormatARB)( HDC hdc, const int *WIN32PTR piAttribIList, const FLOAT *WIN32PTR pfAttribFList, UINT nMaxFormats, int *WIN32PTR piFormats, UINT *WIN32PTR nNumFormats );
    struct wgl_context *WIN32PTR (WINE_GLAPI *p_wglCreateContextAttribsARB)( HDC hDC, struct wgl_context *WIN32PTR hShareContext, const int *WIN32PTR attribList );
    struct wgl_pbuffer *WIN32PTR (WINE_GLAPI *p_wglCreatePbufferARB)( HDC hDC, int iPixelFormat, int iWidth, int iHeight, const int *WIN32PTR piAttribList );
    BOOL       (WINE_GLAPI *p_wglDestroyPbufferARB)( struct wgl_pbuffer *WIN32PTR hPbuffer );
    void       (WINE_GLAPI *p_wglFreeMemoryNV)( void *WIN32PTR pointer );
    HDC        (WINE_GLAPI *p_wglGetCurrentReadDCARB)(void);
    const char *WIN32PTR (WINE_GLAPI *p_wglGetExtensionsStringARB)( HDC hdc );
    const char *WIN32PTR (WINE_GLAPI *p_wglGetExtensionsStringEXT)(void);
    HDC        (WINE_GLAPI *p_wglGetPbufferDCARB)( struct wgl_pbuffer *WIN32PTR hPbuffer );
    BOOL       (WINE_GLAPI *p_wglGetPixelFormatAttribfvARB)( HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes, const int *WIN32PTR piAttributes, FLOAT *WIN32PTR pfValues );
    BOOL       (WINE_GLAPI *p_wglGetPixelFormatAttribivARB)( HDC hdc, int iPixelFormat, int iLayerPlane, UINT nAttributes, const int *WIN32PTR piAttributes, int *WIN32PTR piValues );
    int        (WINE_GLAPI *p_wglGetSwapIntervalEXT)(void);
    BOOL       (WINE_GLAPI *p_wglMakeContextCurrentARB)( HDC hDrawDC, HDC hReadDC, struct wgl_context *WIN32PTR hglrc );
    BOOL       (WINE_GLAPI *p_wglQueryCurrentRendererIntegerWINE)( GLenum attribute, GLuint *WIN32PTR value );
    const GLchar *WIN32PTR (WINE_GLAPI *p_wglQueryCurrentRendererStringWINE)( GLenum attribute );
    BOOL       (WINE_GLAPI *p_wglQueryPbufferARB)( struct wgl_pbuffer *WIN32PTR hPbuffer, int iAttribute, int *WIN32PTR piValue );
    BOOL       (WINE_GLAPI *p_wglQueryRendererIntegerWINE)( HDC dc, GLint renderer, GLenum attribute, GLuint *WIN32PTR value );
    const GLchar *WIN32PTR (WINE_GLAPI *p_wglQueryRendererStringWINE)( HDC dc, GLint renderer, GLenum attribute );
    int        (WINE_GLAPI *p_wglReleasePbufferDCARB)( struct wgl_pbuffer *WIN32PTR hPbuffer, HDC hDC );
    BOOL       (WINE_GLAPI *p_wglReleaseTexImageARB)( struct wgl_pbuffer *WIN32PTR hPbuffer, int iBuffer );
    BOOL       (WINE_GLAPI *p_wglSetPbufferAttribARB)( struct wgl_pbuffer *WIN32PTR hPbuffer, const int *WIN32PTR piAttribList );
