...
ULONG CDECL ldap_modifyW( WLDAP32_LDAP *ld, PWCHAR dn, LDAPModW *mods[] )
{
    ...
    ret = ldap_modify_ext( ldap_get( ld ), dn ? dnU : "", mods ? modsU : nullmods,
                           NULL, NULL, &msg );
    ...
    PLDAPControlW *serverctrls, PLDAPControlW *clientctrls, ULONG *message )
{
    ...
    ret = map_error( ldap_modify_ext( ldap_get( ld ), dn ? dnU : "", mods ? modsU : nullmods, serverctrlsU,
    ...
    PLDAPControlW *serverctrls, PLDAPControlW *clientctrls )
{
    ...
    ret = map_error( ldap_modify_ext_s( ldap_get( ld ), dn ? dnU : "", mods ? modsU : nullmods,
...
ULONG CDECL ldap_modify_sW( WLDAP32_LDAP *ld, PWCHAR dn, LDAPModW *mods[] )
{
    ...
    ret = map_error( ldap_modify_ext_s( ldap_get( ld ), dn ? dnU : "", mods ? modsU : nullmods, NULL, NULL ));
