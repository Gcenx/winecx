...
ULONG CDECL ldap_addW( WLDAP32_LDAP *ld, PWCHAR dn, LDAPModW *attrs[] )
{
    ...
    ret = ldap_add_ext( ldap_get( ld ), dn ? dnU : "", attrs ? attrsU : nullattrs, NULL, NULL, &msg );
    ...
    PLDAPControlW *serverctrls, PLDAPControlW *clientctrls, ULONG *message )
{
    ...
    ret = map_error( ldap_add_ext( ldap_get( ld ), dn ? dnU : "", attrs ? attrsU : nullattrs, serverctrlsU,
    ...
    PLDAPControlW *serverctrls, PLDAPControlW *clientctrls )
{
    ...
    ret = map_error( ldap_add_ext_s( ldap_get( ld ), dn ? dnU : "", attrs ? attrsU : nullattrs,
...
ULONG CDECL ldap_add_sW( WLDAP32_LDAP *ld, PWCHAR dn, LDAPModW *attrs[] )
{
    ...
    ret = map_error( ldap_add_ext_s( ldap_get( ld ), dn ? dnU : "", attrs ? attrsU : nullattrs, NULL, NULL ));
