...
#define ALL_WIN32_SYSCALLS \
    ...
    SYSCALL_ENTRY( __wine_get_current_process_explicit_app_user_model_id ) /* CW Hack 22310 */ \
    SYSCALL_ENTRY( __wine_get_file_outline_text_metric ) \
    SYSCALL_ENTRY( __wine_get_icm_profile ) \
    SYSCALL_ENTRY( __wine_send_input ) \
    SYSCALL_ENTRY( __wine_set_current_process_explicit_app_user_model_id ) /* CW Hack 22310 */
