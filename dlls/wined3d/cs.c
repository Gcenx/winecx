...
#define WINED3D_TO_STR(type) case type: return #type
        ...
        WINED3D_TO_STR(WINED3D_CS_OP_TEXTURE_CHANGED);
        WINED3D_TO_STR(WINED3D_CS_OP_BUFFER_SWAP_MEM);
        WINED3D_TO_STR(WINED3D_CS_OP_BUFFER_INVALIDATE_RANGE);
